<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/MasterPageAD.Master" AutoEventWireup="true" CodeBehind="QLTaiKhoanAdmin.aspx.cs" Inherits="shopMobileOnline.Admin.DanhSachTK" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div class="qltk-container">
        <div class="qltk-header">
               <h4>Quản lí tài khoản Admin</h4>
            <div class="qltk-btnThemMoi-container">
                <asp:HyperLink ID="HyperLink1" runat="server" NavigateUrl="~/Admin/ADDangKi.aspx">
