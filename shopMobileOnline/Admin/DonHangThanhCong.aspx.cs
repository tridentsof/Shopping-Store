    ...
    public partial class DonHangThanhCong : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                string sql = "SELECT ID_DONHANG, NGAYDH, DBO.TONG_SOLUONG(ID_DONHANG) AS TONGSL, DBO.TTDONHANG(ID_DONHANG) AS THONGTIN, DBO.TONG_DONHANG(ID_DONHANG) AS TONGTIEN, DBO.HIENTHI_TRANGTHAI(TRANGTHAI) AS HIENTHI_TRANGTHAI, TRANGTHAI FROM DONHANG WHERE TRANGTHAI = 3 ORDER BY ID_DONHANG DESC";
