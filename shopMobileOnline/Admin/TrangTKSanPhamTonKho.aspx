<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/MasterPageAD.Master" AutoEventWireup="true" CodeBehind="TrangTKSanPhamTonKho.aspx.cs" Inherits="shopMobileOnline.Admin.TrangTKSanPhamTonKho" %>
     ...
     <div class="adtrangchu-container">
        <section class="section-thongKe">
            <div class="auto-style1">
                <p class="section-item-header header-choDuyet">SẢN PHẨM TỒN KHO</p>
                <table class="table" border="1">
                <tr  class="table-tr">
                    <th class="table-th">Tên Sản Phẩm </th>
                    <th class="table-th">Số Lượng Tồn Kho</th>
