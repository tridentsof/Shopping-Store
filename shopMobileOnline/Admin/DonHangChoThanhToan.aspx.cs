...
{
    public partial class DonHangChoThanhToan : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                string sql = "SELECT ID_DONHANG, NGAYDH, DBO.TONG_SOLUONG(ID_DONHANG) AS TONGSL, DBO.TTDONHANG(ID_DONHANG) AS THONGTIN, DBO.TONG_DONHANG(ID_DONHANG) AS TONGTIEN, DBO.HIENTHI_TRANGTHAI(TRANGTHAI) AS HIENTHI_TRANGTHAI, TRANGTHAI FROM DONHANG WHERE TRANGTHAI = 2 ORDER BY ID_DONHANG DESC";
                ...
                if (dtDH != null && dtDH.Rows.Count > 0)
                {
                    foreach (DataRow dr in dtDH.Rows)
                    {
                        ...
                        table.Append("<td class=\"table-td table-item\"><a href=\"/Admin/ADChiTietDonHang.aspx?t=0&idDH=" + dr["ID_DONHANG"] + "\" class=\"qldh-btnXem\">Chi tiết</a> </td>");
