<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/MasterPageAD.Master" AutoEventWireup="true" CodeBehind="QuanLyKMLoai.aspx.cs" Inherits="shopMobileOnline.Admin.QuanLyKM" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div class="container-discount">
        <h3 class="header-discount">Áp dụng khuyến mãi theo loại sản phẩm</h3>
        <div class="discount-wrapper">
            <p class="p-discount p-type">Chọn loại sản phẩm:</p>
            <div class="edit-container">
                <asp:DropDownList CssClass="edit-container" ID="ddlLoai" runat="server"></asp:DropDownList>
            </div>
